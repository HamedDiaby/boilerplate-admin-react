...
export const HomeComponent:React.FC<IHome> = ({
    ...
    const renderLineChart = useCallback(()=> {
        ...
        return (
            <Section className="ad_chart_section_container">
                <Chart type="line" data={data} options={options} />
            </Section>
        )
    }, []);

    const renderVerticalBarChart = useCallback(()=> {
    ...
    const renderPieChart = useCallback(()=> {
        ...
        return (
            <Section className="ad_chart_section_container ad_chart_width">
                <Chart 
                    type="pie" 
                    data={data} 
                    options={options}
                    className="ad_chart_width"
                />
            </Section>
        )
    }, []);
    ...
    return (
        <Dashboard activePagePath={NavigationPathsEnum.HOME}>
            <div>
                ...
                <div className="ad_group_chart_container">
                    {renderPieChart()}
